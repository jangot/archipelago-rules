...
export class UsersManagementController {
  private readonly logger: Logger = new Logger(UsersManagementController.name);

  constructor(private readonly userService: UsersManagementService) {}
  ...
  //getUserDetailById
  //GET /users-management?email=test@mail.com
  //GET /users-management?phoneNumber=1234567890
