import { IBillerRepository, ILoanInviteeRepository, ILoanRepository, ILoginRepository, IUserRegistrationRepository, IUserRepository } from '@core/shared/interfaces/repositories';
