...
export class LoanResponseDto {
  ...
  @ApiProperty({
    ...
    enum: LoanTypeCodes,
    example: LoanTypeCodes.DirectBillPay,
  })
  type: LoanType;

  @ApiProperty({
    description: 'Indicates if the loan is a lend loan',
    type: 'boolean',
    example: true,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    ...
    enum: LoanStateCodes,
    example: LoanStateCodes.Created,
  })
  state: LoanState;

  @ApiProperty({
    description: 'Closure type of the loan',
    enum: LoanClosureCodes,
    example: LoanClosureCodes.PaidOut,
    required: false,
  })
  @IsOptional()
  @Expose()
  ...
  @ApiProperty({
    description: 'Relationship between lender and borrower',
    type: 'string',
    example: 'Friend',
    required: false,
  })
  ...
  @ApiProperty({
    description: 'User-defined note for the loan',
    type: 'string',
    example: 'This is a personal loan.',
    required: false,
  })
  @IsString()
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Attachment URL for the loan',
    type: 'string',
  ...
  @ApiProperty({
    description: 'Deeplink for sharing or inviting to the loan',
    type: 'string',
    example: 'https://example.com/loan/123',
    required: false,
  })
  @IsString()
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Target user URI for unregistered users',
    type: 'string',
  ...
  @ApiProperty({
    description: 'Billing account number for the Bill Pay Loan',
    type: 'string',
    example: '123456789',
    required: false,
  })
  ...
  @ApiProperty({
    description: 'Index of the current payment',
    type: 'integer',
    example: 3,
    required: false,
  })
  ...
  @ApiProperty({
    ...
    enum: LoanPaymentFrequencyCodes,
    example: LoanPaymentFrequencyCodes.Monthly,
  })
  ...
  @ApiProperty({
    description: 'Fee mode for the loan',
    enum: LoanFeeModeCodes,
    example: LoanFeeModeCodes.Standart,
    required: false,
  })
  @IsOptional()
  @Expose()
  ...
  @ApiProperty({
    description: 'Total fee value for the loan',
    type: 'number',
    example: 50.00,
    required: false,
  })
  ...
  @ApiProperty({
    description: 'Unique identifier for the lender payment account',
    type: 'string',
    format: 'uuid',
    example: NIL,
    required: false,
  ...
  @ApiProperty({
    description: 'Unique identifier for the borrower payment account',
    type: 'string',
    format: 'uuid',
    example: NIL,
    required: false,
  ...
  @ApiProperty({
    description: 'Preset link for the loan',
    type: 'string',
    example: 'https://example.com/preset/123',
    required: false,
  })
  @IsString()
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Date when the loan was last updated',
    type: 'string',
    format: 'date-time',
  ...
  @ApiProperty({
    description: 'Date when the loan was accepted',
    type: 'string',
    format: 'date-time',
