...
const MAX_FILE_SIZE_MB = 100; // Максимальный размер файла в МБ
const BATCH_SIZE = 50; // Размер батча для загрузки в Qdrant
const MAX_CONCURRENT_REQUESTS = 5; // Максимальное количество одновременных запросов к OpenAI
