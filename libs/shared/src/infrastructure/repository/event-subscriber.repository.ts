...
import { IEventSubscriberRepository } from '../interface';

@Injectable()
export class EventSubscriberRepository extends RepositoryBase<EventSubscriber> implements IEventSubscriberRepository {
  ...
  public async getSubscribersByServiceName(subscriberService: EventSubscriberServiceName): Promise<IEventSubscriber[]> {
    throw new Error('Method not implemented.');
  }
  
  public async getSubscribersByEventName(eventName: string): Promise<IEventSubscriber[]> {
    throw new Error('Method not implemented.');
  }
